...
public abstract class Hilt_UserRestroFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_UserRestroFragment() {
    super();
  }

  Hilt_UserRestroFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((UserRestroFragment_GeneratedInjector) this.generatedComponent()).injectUserRestroFragment(UnsafeCasts.<UserRestroFragment>unsafeCast(this));
    }
  }
