...
public abstract class Hilt_RestroListFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_RestroListFragment() {
    super();
  }

  Hilt_RestroListFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RestroListFragment_GeneratedInjector) this.generatedComponent()).injectRestroListFragment(UnsafeCasts.<RestroListFragment>unsafeCast(this));
    }
  }
