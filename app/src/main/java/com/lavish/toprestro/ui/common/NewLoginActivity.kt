        ...
        loginViewModel
                .postLogin(emailId!!, userType!!, object : OnCompleteListener<String> {
                    override fun onResult(name: String) {
                        ...
                        //Welcome
                        Toast.makeText(this@NewLoginActivity, String.format(getString(R.string.welcome), name), Toast.LENGTH_SHORT).show()

                        //Navigate to Activity
                        when(userType) {
                            TYPE_USER -> startActivity(Intent(this@NewLoginActivity, MainActivity::class.java))
                            TYPE_OWNER -> startActivity(Intent(this@NewLoginActivity, OwnerActivity::class.java))
                            TYPE_ADMIN -> startActivity(Intent(this@NewLoginActivity, AdminActivity::class.java))
                        }
                        finish()
                    }
                    ...
                    override fun onError(e: String) {
                        ...
                        if(e == ACCESS_DENIED){
                            LogoutHelper().logout(this@NewLoginActivity, navigate = false)
                            ErrorDialog(this@NewLoginActivity).show(e)
                            return
                        }

                        ErrorDialog(this@NewLoginActivity).show(
            ...
            loginViewModel.loginHelperEvents.collect {
                when(it) {
                    ...
                    is LoginHelperEvents.InputName -> {
                        ...
                        TextInputDialog(this@NewLoginActivity)
